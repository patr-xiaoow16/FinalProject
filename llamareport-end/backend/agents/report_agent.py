        ...
        try:
            ...
            if query_type == "general":
                ...
                if not enable_visualization:
                    enhanced_question += "。本次请求禁止生成可视化：不要调用 generate_visualization 工具。"
            ...
            elif enable_visualization and query_type == "general" and answer_text and len(answer_text.strip()) > 50:
                # 检查是否需要生成可视化
                import re
